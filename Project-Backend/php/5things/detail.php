                        ...
                        <div aria-labelledby="navbarDropdown">
                            <div class="subnav-content">
                                <table class="products">
                                    ...
                                    <tr>
                                        <td><a href="ListProducts.php">Gạch ốp lát</a></td>
                                        <td><a href="ListProducts.php">Xi măng Tây Đô</a></td>
                                        <td><a href="ListProducts.php">Đá 1x2</a></td>
                                        <td><a href="ListProducts.php">Cửa gỗ công nghiệp</a></td>
                                        <td><a href="ListProducts.php">Cát san lấp</a></td>
                                        <td><a href="ListProducts.php">Tôn kẽm</a></td>
                                    </tr>
                                    <tr>
                                        <td><a href="ListProducts.php">Gạch ống</a></td>
                                        <td><a href="ListProducts.php">Xi măng VICEM Hà Tiên</a></td>
                                        <td><a href="ListProducts.php">Đá 4x6</a></td>
                                        <td><a href="ListProducts.php">Cửa thép chống cháy</a></td>
                                        <td><a href="ListProducts.php">Cát đen</a></td>
                                        <td><a href="ListProducts.php">Tôn lạnh</a></td>
                                    </tr>
                                    <tr>
                                        <td><a href="ListProducts.php">Gạch ngói</a></td>
                                        <td><a href="ListProducts.php">Xi măng Vissai</a></td>
                                        <td><a href="ListProducts.php">Đá 0x4</a></td>
                                        <td><a href="ListProducts.php">Cửa nhựa</a></td>
                                        <td><a href="ListProducts.php">Cát bê tông</a></td>
                                        <td><a href="ListProducts.php">Tôn vân gỗ</a></td>
                                    </tr>
                                    <tr>
                                        <td><a href="#"></a></td>
                                        <td><a href="ListProducts.php">Xi măng VICEM Hoàng Thạch</a></td>
                                        <td><a href="ListProducts.php">Đá BT</a></td>
                                        <td><a href="#"></a></td>
                                        <td><a href="#"></a></td>
                                        <td><a href="#"></a></td>
                                    </tr>
...
EOT;
        ...
        <div class="ssElements">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="wrap-voucher">
                                                        ...
                                                        <button onclick="mycheckLogin()"
                                                            class="btnAddAction cart-action orderNow">Thêm vào giỏ
                                                            hàng</button>
                                                    </div>
                                                </td>
                                            </tr>
            ...
            function mycheckLogin() {
                alert("Rất tiếc! Bạn cần đăng nhập để thêm sản phẩm vào giỏ hàng :(");
