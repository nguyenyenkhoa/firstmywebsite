                                ...
                                <div class="subnav-content">
                                    <table class="products">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#">Gạch 3 lỗ</a></td>
                                            <td><a href="#">Gạch ống 4 lỗ</a></td>
                                            <td><a href="#">Gạch bê tông giả đá</a></td>
                                        </tr>
                                    </table>
                                </div>
        ...
        <div>
            <div class="container">
                <div class="card-deck">
                    ...
                    <div class="card-border col h-100 " style="width: 15rem;">
                        <a href="detail.php?sp_ma=<?= $row['sp_ma'] ?>" class="link-products">
                            <div class="card-border col h-100 margincards" style="width: 15rem;">
                                ...
                                <!-- <button class="btn btn-info" href="giohang_themsp.php?sp_ma=<?= $row['sp_ma'] ?>">Thêm
                                    vào giỏ hàng</button> -->
