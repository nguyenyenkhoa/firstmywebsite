            ...
            <div class="row">
                <main role="main" class="listTypeProducts">
                    ...
                    <?php
                        ...
                        $sqlTypeProducts = "select * from `loaisanpham`";
                        $resultTypeProducts = mysqli_query($conn, $sqlTypeProducts);

                        $dataTypeProducts = [];
                        while($rowTypeProducts = mysqli_fetch_array($resultTypeProducts, MYSQLI_ASSOC)){
                            $dataTypeProducts[] = array(
                                'lsp_ma' => $rowTypeProducts['lsp_ma'],
                                'lsp_ten' => $rowTypeProducts['lsp_ten'],
                                'lsp_mota' => $rowTypeProducts['lsp_mota'],
                            );
                        }
                    ...
                    <div class="formStyle">
                        ...
                        <?php
                            if(isset($_POST['btnSave'])){
                                $nameTypeProducts = $_POST['lsp_ten'];
                                $detailTypeProducts = $_POST['lsp_mota'];

                                $sql = "INSERT INTO `loaisanpham` (lsp_ten, lsp_mota) VALUES ('$nameTypeProducts', '$detailTypeProducts');";
