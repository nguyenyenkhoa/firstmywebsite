        ...
        <div class="container-fluid">
            <div class="row">
                <main role="main" class="listTypeProducts">
                    <div class="titleTypeProducts">Quản lý loại sản phẩm</div>
                        ...
                        <table class="table table-bordered table-hover mt-2 tableForm" id="dataTable" style="width:85%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit.php?lsp_ma=<?= $loaisanpham['lsp_ma'] ?>" class="btn btn-info">
                                            Cập nhật
                                        </a>
                                        <a href="delete.php?lsp_ma=<?= $loaisanpham['lsp_ma'] ?>" class="btn btn-light">
                                            Xóa dữ liệu
                                        </a>
                                    </td>
                                </tr>
