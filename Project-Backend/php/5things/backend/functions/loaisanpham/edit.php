            ...
            <div class="row">
                <main role="main" class="listTypeProducts">
                    <div class="titleTypeProducts">
                        <h1 class="titleTypeProducts">Cập nhật loại sản phẩm</h1>
                    </div>
                    <?php
                    ...
                    <div class="formStyle">
                        <form name="frmsanpham" id="frmsanpham" method="post" class="formAdd"
                            action="edit.php?lsp_ma=<?= $loaisanphamRow['lsp_ma'] ?>">
                            <div class="form-group">
                                <label for="lsp_ma">Mã loại sản phẩm</label>
                                <input type="text" class="form-control" id="lsp_ma" name="lsp_ma"
                                    placeholder="Mã loại Sản phẩm" readonly value="<?= $loaisanphamRow['lsp_ma'] ?>">
                                <small id="lsp_maHelp" class="form-text text-muted">Mã loại sản phẩm không được hiệu
                                    chỉnh.</small>
                            </div>
                            <div class="form-group">
                                <label for="lsp_ten">Tên loại</label>
                                <input type="text" class="form-control" id="lsp_ten" name="lsp_ten"
                                    placeholder="Tên loại sản phẩm" value="<?= $loaisanphamRow['lsp_ten'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="lsp_mota">Mô tả loại</label>
                                <input type="text" class="form-control" id="lsp_mota" name="lsp_mota"
                                    placeholder="Mô tả loại sản phẩm" value="<?= $loaisanphamRow['lsp_mota'] ?>">
                            </div>
