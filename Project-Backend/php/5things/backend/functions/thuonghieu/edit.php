            ...
            <div class="row">
                <main role="main" class="listTypeProducts">
                    <div class="titleTypeProducts">
                        <h1 class="titleTypeProducts">Cập nhật thương hiệu</h1>
                    </div>
                    <?php
                        ...
                        $th_ma = $_GET['th_ma'];
                        $sqlSelect = "SELECT * FROM `thuonghieu` WHERE th_ma=$th_ma;";

                        $resultSelect = mysqli_query($conn, $sqlSelect);
                        $thuonghieuRow = mysqli_fetch_array($resultSelect, MYSQLI_ASSOC);
                    ?>

                    <div class="formStyle">
                        <form name="frmsanpham" id="frmsanpham" method="post" class="formAdd"
                            action="edit.php?th_ma=<?= $thuonghieuRow['th_ma'] ?>">
                            <div class="form-group">
                                <label for="th_ma">Mã thương hiệu</label>
                                <input type="text" class="form-control" id="th_ma" name="th_ma"
                                    placeholder="Mã thương hiệu" readonly value="<?= $thuonghieuRow['th_ma'] ?>">
                                <small id="lsp_maHelp" class="form-text text-muted">Mã thương hiệu không được hiệu
                                    chỉnh.</small>
                            </div>
                            <div class="form-group">
                                <label for="th_ten">Tên thương hiệu</label>
                                <input type="text" class="form-control" id="th_ten" name="th_ten"
                                    placeholder="Tên thương hiệu" value="<?= $thuonghieuRow['th_ten'] ?>">
                            </div>
                ...
                if (isset($_POST['btnSave'])) {
                   ...
                   $th_ten = $_POST['th_ten'];
                    ...
                    // Câu lệnh INSERT
                    $sql = "UPDATE `thuonghieu` SET th_ten='$th_ten' WHERE th_ma=$th_ma;";
